...
func SendProbe(iface *net.Interface, scopes, types []string, namespaces map[string]string) ([]string, error) {
	...
	msg := []byte(probeSOAP.String())
	return sendUDPMulticast(msg, iface)

}

func sendUDPMulticast(msg []byte, iface *net.Interface) (result []string, err error) {
